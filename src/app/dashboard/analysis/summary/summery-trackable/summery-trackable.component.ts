...
@Component({
  selector: 'app-summery-trackable',
  templateUrl: './summery-trackable.component.html',
  styleUrls: ['./summery-trackable.component.scss']
})
export class SummeryTrackableComponent implements OnInit {
